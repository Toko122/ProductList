...
const Popup = ({ selectedProducts, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white px-8 py-6 flex flex-col gap-4 justify-start rounded-md relative w-[600px] overflow-scroll">
          ...
          <div className='text-[#7c7c7c]'>${(product.price * product.count).toFixed(2)}</div>
                    ...
                    <p>No items Selected</p>
                     ...
                     <div className='flex justify-between items-center'>
                       <div className='text-[#767676] text-[16px] font-semibold'>
                          Order Total
                         </div>
            ...
            <button className='w-full py-2 rounded-[20px] sm:px-24 px-14 bg-red-600 flex justify-center items-center sm:text-[16px] text-[14px] text-white font-semibold'>Start New Order</button>
